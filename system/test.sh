...
for rc_value in "${rc_values[@]}"; do
    ...
    cat "command2_$cdr_value+_$jr_value+_$rc_value.log" > "log_BestEntropy_$cdr_value+_$jr_value+_$rc_value.txt"
    ...
    rm "log_BestEntropy_$cdr_value+_$jr_value+_$rc_value.log" "log_BestEntropy_$cdr_value+_$jr_value+_$rc_value.log" #"log_BellowAverage_$cdr_value+_$jr_value+_$rc_value.log"
